...
) ENGINE=InnoDB AUTO_INCREMENT=510 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='告警规则表';

-- ----------------------------
-- Records of eq_alarm_rule
-- ----------------------------
BEGIN;
INSERT INTO `eq_alarm_rule` VALUES (1, '温度过高', 1, '1100800013', '', '[{\"property\":\"temperature\",\"condition\":0,\"value\":90}]', 1, 1, '2022-05-21 10:26:13', '2022-05-21 10:58:26', NULL);
INSERT INTO `eq_alarm_rule` VALUES (2, '温度过低', 1, '1100800013', '', '[{\"property\":\"temperature\",\"condition\":2,\"value\":10}]', 1, 0, '2022-05-21 10:58:49', '2022-05-21 10:58:49', NULL);
INSERT INTO `eq_alarm_rule` VALUES (3, '温湿度异常', 0, '1100800013', '', '[{\"property\":\"temperature\",\"condition\":0,\"value\":50},{\"property\":\"humidity\",\"condition\":0,\"value\":70}]', 1, 0, '2022-05-21 10:59:59', '2022-05-21 10:59:59', NULL);
INSERT INTO `eq_alarm_rule` VALUES (4, '设备温度过高', 1, '', 'tc_0001', '[{\"property\":\"temperature\",\"condition\":0,\"value\":60}]', 0, 0, '2022-05-21 10:59:59', '2022-05-21 10:59:59', NULL);
INSERT INTO `eq_alarm_rule` VALUES (5, '湿度范围测验', 0, '', 'tc_0001', '[{\"property\":\"humidity\",\"condition\":0,\"value\":[30,60]}]', 0, 0, NULL, NULL, NULL);
COMMIT;
